...
## Table of Contents
- [Overview](https://github.com/aniketrepo/facial-recognition-system#overview)
- [Objectives](https://github.com/aniketrepo/facial-recognition-system#objectives)
- [How the system works](https://github.com/aniketrepo/facial-recognition-system#how-the-system-works)
- [Project Structure](https://github.com/aniketrepo/facial-recognition-system#project-structure)
- [Dataset Description](https://github.com/aniketrepo/facial-recognition-system#dataset-description)
	- [Dataset Source](https://github.com/aniketrepo/facial-recognition-system#dataset-source)
- [System Architecture](https://github.com/aniketrepo/facial-recognition-system#system-architecture)
- [Model Architecture](https://github.com/aniketrepo/facial-recognition-system#model-architecture)
- [Technologies Used](https://github.com/aniketrepo/facial-recognition-system#technologies-used)
...
- [Installation Instructions](https://github.com/aniketrepo/facial-recognition-system#installation-instructions)
	- [Step 1](https://github.com/aniketrepo/facial-recognition-system#step-1-clone-the-repository)
	- [Step 2](https://github.com/aniketrepo/facial-recognition-system#step-2-install-dependencies)
- [Training the Model](https://github.com/aniketrepo/facial-recognition-system#training-the-model)
- [Real-Time Emotion Recognition](https://github.com/aniketrepo/facial-recognition-system#real-time-emotion-recognition)
	- [Controls](https://github.com/aniketrepo/facial-recognition-system#controls)
- [Output](https://github.com/aniketrepo/facial-recognition-system#output)
- [Performance Notes](https://github.com/aniketrepo/facial-recognition-system#performance-notes)
- [Limitations](https://github.com/aniketrepo/facial-recognition-system#limitations)
- [Future Enhancements](https://github.com/aniketrepo/facial-recognition-system#future-enhancements)
- [Conclusion](https://github.com/aniketrepo/facial-recognition-system#conclusion)
